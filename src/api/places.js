...
const NAME_HINTS = {
  ...
  Caribbean: ['caribbean', 'jamaican', 'jerk chicken'],
  Chinese: ['chinese', 'dim sum', 'szechuan', 'sichuan', 'cantonese'],
  Coffee: ['coffee', 'espresso', 'roasters', 'roastery'],
  Dessert: ['dessert', 'ice cream', 'gelato', 'creamery', 'donut', 'doughnut', 'cupcake'],
  Diner: ['diner'],
  ...
  'Middle Eastern': ['shawarma', 'falafel', 'lebanese', 'turkish', 'persian'],
  Peruvian: ['peruvian', 'ceviche'],
  Pizza: ['pizza', 'pizzeria'],
  'Puerto Rican': ['puerto rican', 'boricua'],
  Seafood: ['seafood', 'oyster', 'crab shack'],
  'Southern Comfort': ['soul food', 'cajun', 'creole'],
  Thai: ['thai', 'pad thai'],
